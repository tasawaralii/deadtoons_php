<style>.telegram b{color:#a32c2c;}</style>
<div class="herald-sidebar col-lg-3 col-md-3 herald-sidebar-right">
    <div id="custom_html-4" class="widget_text widget widget_custom_html">
        <h4 class="widget-title h6"><span>Follow On Social Media</span></h4>
        <div class="textwidget custom-html-widget"><div class="telegram">
            ...
            <a href="https://t.me/addlist/slvdlq5NovRmYzI0" target="_blank" rel="noopener">
                <img src="/content/2024/01/images-20.jpeg" alt="Deadtoons Telegram" />
            </a>
